...
class player {
    ...
    public int getTotalTokens() {return this.busToken + this.taxiToken + this.subwayToken + this.subwayToken + this.blackToken;}
    ...
    public boolean hasBlackToken(){
        if (this.getBlackToken()!=0) return true; else return false;
    }
